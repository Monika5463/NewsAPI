...
class NewsApp:
    ...
    def __init__(self):
        # fetch data
        self.data=requests.get("https://newsapi.org/v2/top-headlines?country=in&apiKey=210d762b712143c5b680b54d651d6372").json()
        # print(self.data)
        # Initial GUI load
        self.load_gui()
